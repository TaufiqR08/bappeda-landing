...
<head>
  ...
  <title>Bappeda Sumbawa Barat</title>
  <meta name="description" content="">
  <meta name="keywords" content="">

  <!-- Favicons -->
  <link href="template/assets/img/bappeda.png" rel="icon">
...
<body class="index-page">
  ...
  <header id="header" class="header sticky-top">
      ...
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="d-none d-md-flex align-items-center" id="current-date-time">
    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-end">
        <a href="#hero" class="logo d-flex align-items-center me-auto">
          <img src="template/assets/img/logobappedanew.png" alt="">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="#featured-services">Aplikasi</a></li>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          <img src="template/assets/img/hero-carousel/bappedagd.jpg" alt="">
          <div class="container">
            <h2>Badan Perencanaan Pembangunan Daerah</h2>
            <p>Badan Perencanaan Pembangunan Daerah, disingkat Bappeda, adalah lembaga teknis daerah dibidang penelitian dan perencanaan pembangunan daerah yang dipimpin oleh seorang kepala badan yang berada dibawah dan bertanggung jawab kepada Gubernur/Bupati/Wali kota melalui Sekretaris Daerah.</p>
        ...
        <div class="carousel-item">
          <img src="template/assets/img/hero-carousel/Masjid_Sumbawa_Barat.jpg" alt="">
          <div class="container">
            <h2>Masjid Agung Darussalam</h2>
            <p>Masjid Agung Darussalam Sumbawa Barat merupakan sebuah masjid yang terletak di Kabupaten Sumbawa Barat, Indonesia. Masjid ini dibangun pada tahun 2007 dan selesai pada tahun 2010. Bentuk ini pula menjadi ciri khas setiap bangunan dan berbagai aktivitas administrasi pemerintah dan masyarakat kabupaten Sumbawa Barat.</p>
            <!-- <a href="#about" class="btn-get-started">Read More</a> -->
          </div>
        </div><!-- End Carousel Item -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">E-MUSRENBANG</a></h4>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <p>Rencana Pembangunan Jangka Panjang Nasional</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <p>Rencana Pembangunan Jangan Menengah Nasional</p>
            </div>
          </div><!-- End Service Item -->
    ...
    <section id="contact" class="contact section">
      ...
      <div class="mb-5" data-aos="fade-up" data-aos-delay="200">
        <iframe style="border:0; width: 100%; height: 370px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15773.338073177043!2d116.85037312772816!3d-8.754562442674182!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dcc66dd26239ac3%3A0xb999a183e66b18e8!2sBappeda%20Kabupaten%20Sumbawa%20Barat!5e0!3m2!1sid!2sid!4v1737518360973!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" frameborder="0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div><!-- End Google Maps -->
  ...
  <footer id="footer" class="footer light-background">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">BAPPEDAKSB</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateDateTime() {
      ...
      const displayText = `${currentDay}, ${currentDate} ${currentMonth} ${currentYear} - ${currentTime}`;
      
      const dateTimeElement = document.getElementById("current-date-time");
      dateTimeElement.innerHTML = `<i class="bi bi-clock me-1"></i> ${displayText}`;
    }

    // Jalankan fungsi updateDateTime setiap 1 detik
    setInterval(updateDateTime, 1000);

    // Panggil fungsi sekali untuk menampilkan waktu langsung saat halaman dimuat
    updateDateTime();
  });
</script>
